...
type PorterClient interface {
	SayHello(ctx context.Context, in *Hello_Request, opts ...grpc.CallOption) (*Hello_Response, error)
}
...
func (c *porterClient) SayHello(ctx context.Context, in *Hello_Request, opts ...grpc.CallOption) (*Hello_Response, error) {
	out := new(Hello_Response)
	err := c.cc.Invoke(ctx, "/service.Porter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PorterServer interface {
	SayHello(context.Context, *Hello_Request) (*Hello_Response, error)
...
func (UnimplementedPorterServer) SayHello(context.Context, *Hello_Request) (*Hello_Response, error) {
...
func _Porter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Hello_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PorterServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Porter/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PorterServer).SayHello(ctx, req.(*Hello_Request))
	}
...
var Porter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.Porter",
	HandlerType: (*PorterServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _Porter_SayHello_Handler,
		},
	},
